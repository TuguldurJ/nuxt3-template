...
<template>
    <div>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex justify-between h-16">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <NuxtLink :to="'/'">
                                <img class="block lg:hidden h-8 w-auto"
                                    src="@/assets/images/rcbullion-rtr-logo-mini.png" alt="rcbullionrtr" />
                                <img class="hidden lg:block h-16 w-auto"
                                    src="@/assets/images/rcbullion-rtr-logo-white.png" alt="rcbullionrtr" />
                            </NuxtLink>
                        </div>
                        ...
                        <div class="max-w-lg w-full lg:max-w-xs">
                            ...
                            <div class="relative">
                                ...
                                <input id="search" name="search"
                                    class="block w-full pl-10 pr-3 py-2 borderborder-transparent rounded-md leading-5 bg-gray-700 text-gray-300 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-white focus:ring-white focus:text-gray-900 sm:text-sm"
                    ...
                    <div class="flex items-center lg:hidden">
                        ...
                        <!-- Mobile menu button -->
                        <DisclosureButton
                            class="inline-flex items-center justify-center p-2 rounded-full text-gray-400 hover:text-white hover:bg-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
        ...
        <div class="absolute inset-x-0 bottom-0 h-px bg-zinc-600"></div>
    </div>
</template>